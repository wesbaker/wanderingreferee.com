...
description: Humor is something I want at the table, even if the game isn't a comedy.
  It's worth talking about up front, and when it lands well it can make a session
  far more memorable.
tags:
- rpgaday
- rpgs
