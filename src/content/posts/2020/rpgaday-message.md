...
description: I like messages that create tension, whether that's a private note about
  hidden information or an out-of-game message that keeps bookkeeping away from session
  time. Both kinds can make a campaign run better.
tags:
- rpgaday
- rpgs
---
